            ...
            <div className="stickers">
                {
                    fwcFront.map((number, index)=>{
                        return <StickerNumber key={index} number={number} setStickersCollected={setStickersCollected} />
                    })
                }
            </div>
        </div>
            ...
            countries.map((country, index)=>{
                    ...
                    <div className="stickers">
                {
                    stickers.map((item, index)=>{
                        return <StickerNumber key={index} number={item.number} setStickersCollected={setStickersCollected}   />
                    })
                }
                    </div>
                </div>
